...
extension Action {
    ...
    ///
    @MainActor public static func map<V1>(_ transform: @escaping (Self) -> V1) -> ActionTriggerStep1<V1> {
    ...
    ///
    @MainActor public static func map<V1, V2>(_ transform1: @escaping (Self) -> V1, _ transform2: @escaping (Self) -> V2) -> ActionTriggerStep2<V1, V2> {
    ...
    ///
    @MainActor public static func map<V1, V2, V3>(_ transform1: @escaping (Self) -> V1, _ transform2: @escaping (Self) -> V2, _ transform3: @escaping (Self) -> V3) -> ActionTriggerStep3<V1, V2, V3> {
    ...
    ///
    @MainActor public static func compactMap<V1>(_ transform: @escaping (Self) -> V1?) -> ActionTriggerStep1<V1> {
        ActionTriggerStep1 { action, _ in
            AsyncStream { continuation in
